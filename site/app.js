const translations = {
  zh: {
    ...
    learning1Title: "設定 row filter，不代表租戶真的被隔離。",
    ...
    scopeBody: "這是使用 synthetic data 的 verified PoC。四組 AWS 操作路徑已於 2026-08-03 實際操作驗證；PoC 雲端執行資源於 2026-08-05 完整拆除以避免閒置成本，並可由 CDK 重建。本專案不宣稱 production workload 經驗。",
  ...
  en: {
    ...
    learning1Title: "Configuring a row filter did not prove tenant isolation.",
    ...
    lessonsLink: "Designs changed by testing",
    scopeTitle: "Honest scope",
    scopeBody: "This is a verified PoC using synthetic data. The four AWS operation paths were operated and verified on 2026-08-03; the PoC runtime resources were fully retired on 2026-08-05 to avoid idle cost and remain reproducible from CDK. This project makes no production-workload claim.",
    closingKicker: "THE TAKEAWAY",
