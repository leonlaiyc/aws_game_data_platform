const translations = {
  zh: {
    ...
    engineeringBody: "由 OPEN ticket 標示需要人工接手的案件",
    ...
    decision3Situation: "狀況：現在是 PoC 階段，需要比較精細的安全性控制。",
  ...
  en: {
    ...
    engineeringBody: "OPEN tickets mark cases that require a person",
    sharedRailTitle: "SHARED CONTROL PLANE",
    ...
    decision3Situation: "Situation: The current PoC needs relatively fine-grained security control.",
