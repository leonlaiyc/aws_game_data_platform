const translations = {
  zh: {
    ...
    heroLede: "以 Serverless 為主的設計，建構於資料共用、權限邊界與成本控制之上，解決異常偵測、實驗運營、臨時分析與合作夥伴支援問題。",
    ...
    silverBadge: "分析與已知風險特徵來源",
    goldStageBody: "KPI · 留存 · 玩家特徵 · 實驗資料",
    ...
    architectureM1Title: "異常與已知風險偵測",
    architectureM1Body: "每日 DAU／GGR、每週留存與雙訊號風險檢查；告警自動觸發 M3 first-look，flagged players 另交人工審查。",
    ...
    architectureM4Title: "身份隔離的 RAG 輔助支援",
    architectureM4Body: "IAM 身份先選定 provider 或 operator 文檔；相關性與 code validator 通過才回覆，否則澄清或建立 OPEN ticket。",
    ...
    wf4System: "系統先依 IAM 權限選定可讀取的文檔庫，經相關性門檻過濾後將合格文檔交給 AWS Bedrock 產生解答；若文檔資料不足，則請使用者澄清說明或自動開單轉人工處理。",
    wf4Human: "當文檔無法回答、AI 回覆未通過安全驗證，或案件需要產品／工程判斷時，系統會建立 OPEN ticket 供人工接手。目前 PoC 只將工單存進 DynamoDB，尚未串接 Email、Slack 或 CRM 通知。",
    ...
    demoTitle: "兩分鐘精華：工作流運行與產出展示",
    demoIntro: "分章節拆解四組核心模組，即時呈現問題觸發條件與系統自動處置過程。",
    demoVideoTitle: "正式字幕版 · 02:00",
    demoVideoNote: "2026-08-01 重新驗證 AWS 路徑 · 1080p · 無聲版本",
    ...
    scopeBody: "這是使用 synthetic data 的 verified PoC。成片中的四組 AWS 操作路徑已於 2026-08-01 重新驗證；本專案仍不宣稱 production workload 經驗。",
  ...
  en: {
    ...
    heroLede: "Built primarily on serverless services, the design combines shared data, access boundaries and cost controls to address anomaly detection, experiment operations, ad-hoc analytics and partner support.",
    ...
    p4Title: "Repeated customer questions consume support and engineering capacity.",
    ...
    silverStageBody: "Typed Parquet events",
    silverBadge: "Source for analytics and known-risk features",
    goldStageBody: "KPI · retention · player features · experiment data",
    ...
    architectureM1Title: "Anomaly and known-risk detection",
    architectureM1Body: "Daily DAU/GGR, weekly retention and two-signal risk checks; alerts automatically trigger M3 first-look, while flagged players follow a separate human-review path.",
    ...
    architectureM3Branch: "Grounded answer · first-look report · durable ticket",
    architectureM4Title: "Identity-isolated RAG-assisted support",
    architectureM4Body: "IAM identity selects the provider or operator corpus. Only answers that pass relevance and code validation are returned; otherwise the system clarifies or opens a ticket.",
    ...
    wf4System: "The system uses IAM permissions to select the document library the caller may read, filters it through a relevance threshold, and gives qualified documents to AWS Bedrock to produce an answer. If the documents are insufficient, it asks for clarification or opens a ticket for human handling.",
    wf4Human: "The system creates an OPEN ticket when documents cannot answer, an AI response fails safety validation, or product/engineering judgement is required. The PoC stores the ticket in DynamoDB but does not yet send Email, Slack or CRM notifications.",
    ...
    demoKicker: "FOUR CHAPTERS · TWO MINUTES",
    demoTitle: "Two-minute highlights: workflows in motion and their outputs.",
    demoIntro: "Four chapters break down the core modules, showing each trigger and the system's automated response in real time.",
    demoVideoTitle: "Final subtitled cut · 02:00",
    demoVideoNote: "AWS paths re-verified on 2026-08-01 · 1080p · silent cut",
    ...
    lessonsLink: "Designs changed by testing",
    scopeTitle: "Honest scope",
    scopeBody: "This is a verified PoC using synthetic data. The four AWS operation paths shown in the video were re-verified on 2026-08-01; this project still makes no production-workload claim.",
    closingKicker: "THE TAKEAWAY",
