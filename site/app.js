const translations = {
  zh: {
    ...
    heroLede: "以 Serverless 為主的設計，建構於資料共用、權限邊界與成本控制之上，解決異常偵測、實驗運營、臨時分析與技術文件指引問題。",
    ...
    m4Short: "技術文件指引",
    p4Title: "重複性文件查找消耗整合與開發資源。",
    p4Body: "不同時區的合作夥伴經常反覆查找相似的 API 驗證、Webhook 與環境設定；常見問題需要重複說明，資訊不足的案件則缺少結構化脈絡才轉交工程團隊。",
    ...
    architectureM4Title: "身份隔離的技術文件助理",
    architectureM4Body: "IAM 身份先選定可讀文件範圍；相關性與 code validator 通過才回覆，否則澄清或建立 OPEN ticket。",
    ...
    wf4Title: "RAG-style 技術文件助理",
    wf4Before: "整合團隊重複查找與說明技術文件；資訊不足時，問題缺乏結構化脈絡就轉給工程師。",
  ...
  en: {
    ...
    heroLede: "Built primarily on serverless services, the design combines shared data, access boundaries and cost controls to address anomaly detection, experiment operations, ad-hoc analytics and technical guidance.",
    ...
    m4Short: "Technical guidance",
    p4Title: "Repeated documentation lookup consumes integration and engineering capacity.",
    p4Body: "Partners across time zones repeatedly look for the same API authentication, webhook and environment guidance. Common questions require repeated explanation, while under-specified cases reach engineering without structured context.",
    architectureKicker: "SYSTEM SHAPE & BOUNDARIES",
    ...
    architectureM3Branch: "Grounded answer · first-look report · durable ticket",
    architectureM4Title: "Identity-isolated technical documentation assistant",
    architectureM4Body: "IAM identity selects the document scope. Only answers that pass relevance and code validation are returned; otherwise the system clarifies or opens a ticket.",
    ...
    wf4Title: "RAG-style technical documentation assistant",
    wf4Before: "Integration teams repeated the same documentation guidance and forwarded under-specified questions to engineers without enough context.",
...
const demoChapters = {
  zh: {
    ...
    m4: {
      title: "M4 / RAG-STYLE KNOWLEDGE & LEAKAGE CONTROL",
      pain: "重複文件查找消耗整合資源；資訊不足的問題缺乏結構就轉給工程師。",
      result: "系統先澄清、再回答或建立 ticket；模型洩漏被 code validator 擋下。",
      terminal: [
        "$ run integration-knowledge demo",
  ...
  en: {
    ...
    m4: {
      title: "M4 / RAG-STYLE KNOWLEDGE & LEAKAGE CONTROL",
      pain: "Repeated documentation lookup consumed integration capacity; under-specified cases reached engineers without structure.",
