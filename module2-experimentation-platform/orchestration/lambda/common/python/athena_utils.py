"""Shared Athena polling helper, packaged as a Lambda Layer (see
infra/infra/orchestration_stack.py) so assignment/monitoring_check/analysis
don't each reimplement start-query -> poll -> fetch-results.
"""
import os
import time
